...
<!-- Page Content -->
                ...
                <div class="container page__container page-section" data-select2-id="30">

                    <div class="row mb-32pt" data-select2-id="29">
                        <div class="col-lg-4">
                            <div class="page-separator">
                                <div class="page-separator__text">Select2</div>
                            </div>
                            <p class="card-subtitle text-70 mb-16pt mb-lg-0">Customizable select box with support for searching, tagging, remote data sets, infinite scrolling, and many other highly used options powered by Select2. Please read the <a href="https://select2.org/" target="_blank">official plugin documentation</a> for a full list of options.</p>
                        </div>
